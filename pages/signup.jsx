                ...
                <div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    <div class="w-full container mx-auto">
                        ...
                        <div class="w-full flex items-center justify-between">
                            ...
                            <form class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4" action='/api/signup' method='POST'>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label class="block text-blue-300 py-2 font-bold mb-2" for="wallet">
